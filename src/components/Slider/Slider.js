...
import './slider.scss';
//import img1 from '../../static/images/sliderImages/slide1.jpg';
        ...
        return(
            <div className="slider-wrapper">
                <ul className="Slider-list" style={{...style, marginLeft: this.state.marginLeft+"%"}}>
                    <li className="slide"><img  alt="image1"/></li>
                    <li className="slide"><img  alt="image2"/></li>
                    <li className="slide"><img  alt="image3"/></li>
                </ul>
